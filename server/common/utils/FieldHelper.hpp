...
// 简化宏
#define F_STR(field) FieldHelper::getString(field)
#define F_STR_DEF(field, def) FieldHelper::getString(field, def)
#define F_INT(field) FieldHelper::getInt(field)
#define F_INT_DEF(field, def) FieldHelper::getInt(field, def)
#define F_BOOL(field) FieldHelper::getBool(field)
#define F_BOOL_DEF(field, def) FieldHelper::getBool(field, def)
